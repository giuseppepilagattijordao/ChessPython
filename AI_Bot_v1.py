...
# 50% of the moves are based on data of my games
# 50% are the best moves of stockfish
# =============================================================================
def PEPE_AI_v1(model, legal_features, legal_y, board):
        ...
        if board.fen() == 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1':
            ...
            numeric_part, engine_move = StockFish(board)
            
            #assign a probability to choose move based on data or based on stockihsh:
